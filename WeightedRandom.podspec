#
#  Be sure to run `pod spec lint WeightedRandom.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Victor Hyde"
  # s.authors            = { "Victor Hyde" => "tonikone@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Victor Hyde"
